...
parser.add_argument('-m', '--model', type=str, default='TGCN',
                    help='Mode of operation: generate or visualise')
parser.add_argument('-t', '--target_idx', type=int, default=12,
...
parser.add_argument('-d', '--dataset', type=str,
                    default='METR_LA', help='Dataset name')
parser.add_argument('--stx_mode', type=str, default='fidelity',
